...
; RUN: opt -basicaa -memcpyopt-mssa -S %s | FileCheck %s --check-prefix=MCO-MSSA
...
; CHECK-NEXT:    call void @llvm.memset.p0i8.i64(i8* [[TMP4]], i8 %c, i64 [[TMP3]], i32 1, i1 false)
...
; CHECK-NEXT:    call void @llvm.memset.p0i8.i64(i8* [[TMP4]], i8 0, i64 [[TMP3]], i32 4, i1 false)
...
; CHECK-NEXT:    [[DST:%.*]] = bitcast i64* [[DST:%.*]]_pi64 to i8*
; CHECK-NEXT:    [[TMP1:%.*]] = icmp ule i64 [[DST]]_size, %src_size
; CHECK-NEXT:    [[TMP2:%.*]] = sub i64 [[DST]]_size, %src_size
; CHECK-NEXT:    [[TMP3:%.*]] = select i1 [[TMP1]], i64 0, i64 [[TMP2]]
; CHECK-NEXT:    [[TMP4:%.*]] = getelementptr i8, i8* [[DST]], i64 %src_size
; CHECK-NEXT:    call void @llvm.memset.p0i8.i64(i8* [[TMP4]], i8 %c, i64 [[TMP3]], i32 1, i1 false)
; CHECK-NEXT:    call void @llvm.memcpy.p0i8.p0i8.i64(i8* [[DST]], i8* %src, i64 %src_size, i32 1, i1 false)
