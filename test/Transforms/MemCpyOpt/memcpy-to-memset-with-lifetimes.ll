...
; RUN: opt -basicaa -memcpyopt-mssa -instcombine -S < %s | FileCheck %s --check-prefix=MCO-MSSA
...
; CHECK-NEXT:    call void @llvm.lifetime.start(i64 64, i8* [[A_CAST]])
; CHECK-NEXT:    call void @llvm.memset.p0i8.i64(i8* [[A_CAST]], i8 0, i64 64, i32 8, i1 false)
; CHECK-NEXT:    [[SRET_CAST:%.*]] = bitcast [8 x i64]* %sret to i8*
; CHECK-NEXT:    call void @llvm.memset.p0i8.i64(i8* [[SRET_CAST]], i8 0, i64 64, i32 8, i1 false)
; CHECK-NEXT:    call void @llvm.memset.p0i8.i64(i8* [[A_CAST]], i8 42, i64 32, i32 8, i1 false)
