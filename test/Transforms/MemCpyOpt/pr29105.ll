...
; RUN: opt -memcpyopt-mssa -instcombine -S %s | FileCheck %s --check-prefix=MCO-MSSA
%Foo = type { [2048 x i64] }
...
; CHECK-NEXT:    call void @llvm.lifetime.start(i64 16384, i8* [[TMP0]])
; CHECK-NEXT:    call void @llvm.memset.p0i8.i64(i8* [[TMP0]], i8 0, i64 16384, i32 8, i1 false)
