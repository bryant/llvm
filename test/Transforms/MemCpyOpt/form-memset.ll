...
; CHECK-LABEL: @test2(
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[REF_IDX:%.*]] = alloca [8 x i8]
; CHECK-NEXT:    [[LEFT_MVD:%.*]] = alloca [8 x %struct.MV]
; CHECK-NEXT:    [[UP_MVD:%.*]] = alloca [8 x %struct.MV]
...
; CHECK-LABEL: @test8(
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[MEMTMP:%.*]] = alloca %struct.test8, align 16
